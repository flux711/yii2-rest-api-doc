			...
			<div class="panel panel-default">
				...
				<div id="<?= $entity['title'] ?>" class="panel-collapse collapse" role="tabpanel">
					<div class="panel-body">
						...
						<div class="list-group" id="<?= $entity['title'] ?>-list" role="tablist"
							 aria-multiselectable="true">
							<?php foreach($entity['rules'] as $ri => $rule) : ?>
								<a class="endpoint-toggle list-group-item" role="button"
								   data-parent="#<?= $entity['title'] ?>-list" data-toggle="collapse"
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<span class="col-lg-11 text-nowrap ellipsis">
                                                ...
                                                <?php if (!empty($rule['description']['short'])) : ?>
													-
													<i><?= htmlspecialchars(strip_tags($rule['description']['short'])) ?></i>
												<?php endif; ?>
                                            </span>
								...
								<div id="rule-<?= $ei ?>-<?= $ri ?>" class="panel panel-primary collapse"
									 role="tabpanel">
									<div class="panel-body">
										<?php if (!empty($rule['description']['extended'])) : ?>
											<p><?= $rule['description']['extended'] ?></p>
										<?php endif ?>
										<form class="form">
												...
												<fieldset class="params">
													...
													<?php foreach($rule['params'] as $param) : ?>
														<div class="form-group">
															...
															<input data-key="<?= $param['key'] ?>" class="form-control"
												...
												<fieldset class="filters">
													...
													<?php foreach($rule['filters'] as $filter) : ?>
														<div class="form-group">
															...
															<input data-key="<?= $filter['key'] ?>" class="form-control"
																   type="text"/>
														</div>
													<?php endforeach; ?>
												</fieldset>
											...
											<div class="response well">
												...
												<div class="data hidden">
													<h5>Action: <?= $rule['method'] ?> <span class="final-url"></span>
													</h5>
